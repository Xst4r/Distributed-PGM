...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{.5\textwidth}
        ...
        \end{subfigure}
    \caption[Distributed vs. Federated Architecture]{Distributed vs. Federated architecture, featuring four devices either connected to each other or connected to a coordinator device. The coordinator in the right illustration does not have access to the data.}
