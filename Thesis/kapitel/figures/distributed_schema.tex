\begin{figure}[!htb]
    ...
    \begin{tikzpicture}
        ...
        \Vertex[x=2,y=2,color=tugray, opacity=0.5,label=Device 1, size=1.5, shape=diamond]{d1}
        \Vertex[x=6,y=2,color=tugray, opacity=0.5,label=Device 2, size=1.5, shape=diamond]{d2}
        \Vertex[x=14,y=2,color=tugray, opacity=0.5,label=Device n, size=1.5, shape=diamond]{dn}
        ...
        \Vertex[x=5,y=9,color=tugreen,opacity=0.5,label=Aggregate, size=2, shape=circle]{a}
