...
In that case, we check if the coefficient matrix from \eq~\ref{eq:radonopt} is singular, and if it is, we switch to a least-squares optimization approach to obtain a feasible solution. 
